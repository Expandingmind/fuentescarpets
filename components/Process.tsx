            ...
            <div className="space-y-4 md:space-y-8 mb-8 md:mb-12">
              ...
              <FadeIn direction="right" delay={200}>
                <div className="flex items-start">
                  ...
                  <div className="ml-3 md:ml-4">
                    <h3 className="text-base md:text-xl font-bold text-gray-900 mb-0.5 md:mb-2">Convenience at Its Best</h3>
              ...
              <FadeIn direction="right" delay={300}>
                <div className="flex items-start">
                  ...
                  <div className="ml-3 md:ml-4">
                    <h3 className="text-base md:text-xl font-bold text-gray-900 mb-0.5 md:mb-2">Customized Solutions</h3>
                    <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed">
              ...
              <FadeIn direction="right" delay={400}>
                <div className="flex items-start">
                  ...
                  <div className="ml-3 md:ml-4">
                    <h3 className="text-base md:text-xl font-bold text-gray-900 mb-0.5 md:mb-2">Unmatched Expertise & Quality</h3>
                    <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed">
          ...
          <div className="relative h-[300px] md:h-[600px] w-full">
            <FadeIn direction="left" delay={300} className="h-full">
              ...
              <img 
                ...
                className="relative w-full h-full object-cover rounded-[1.5rem] md:rounded-[3rem] shadow-2xl bg-gray-200"
              />
            </FadeIn>
          </div>
        </div>
