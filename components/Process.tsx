            ...
            <div className="space-y-6 md:space-y-8 mb-10 md:mb-12">
              ...
              <FadeIn direction="right" delay={200}>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Convenience at Its Best</h3>
              ...
              <FadeIn direction="right" delay={400}>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Unmatched Expertise & Quality</h3>
                    <p className="text-sm md:text-base text-gray-600 leading-relaxed">
          ...
          <div className="relative h-[400px] md:h-[600px] w-full">
            <FadeIn direction="left" delay={300} className="h-full">
              ...
              <img 
                ...
                className="relative w-full h-full object-cover rounded-[2rem] md:rounded-[3rem] shadow-2xl bg-gray-200"
              />
            </FadeIn>
          </div>
        </div>
