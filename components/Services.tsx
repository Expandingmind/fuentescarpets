...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: 'Custom stair carpeting to add safety and style. Beautiful runners that protect stairs while enhancing your home.',
          ...
          {services.map((service, index) => (
            <div key={index} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <button onClick={scrollToContact} className="text-primary font-semibold hover:text-primary-dark transition-colors inline-flex items-center group/btn">
                  Learn More
