          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>
                ...
                <a href="tel:+13053236368" className="hover:text-white transition-colors">
                  (305) 323-6368
                </a>
              </li>
              <li>
                <p className="font-semibold text-white mb-1">Email</p>
                <a href="mailto:fuentescarpets@gmail.com" className="hover:text-white transition-colors break-all">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 bg-gray-800 hover:bg-primary rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
