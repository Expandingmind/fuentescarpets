        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <a href="tel:+13053236368" className="block text-white font-bold hover:text-gray-300 transition-colors">
                  +1 (305) 323-6368
                </a>
                <span className="text-gray-500 text-xs">Got Questions? Call us 24/7</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 text-sm">Based in Miami Dade and Broward County</p>
              </div>
              <div>
                <h4 className="font-bold text-white text-sm mb-1">Email:</h4>
                <a href="mailto:fuentescarpets@gmail.com" className="text-gray-400 text-sm hover:text-white">fuentescarpets@gmail.com</a>
              </div>
