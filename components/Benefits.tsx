    ...
    <section id="benefits" className="py-16 md:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Image */}
          <div className="relative h-[400px] md:h-[600px] w-full order-2 lg:order-1">
            <FadeIn direction="right" delay={200} className="h-full">
              <div className="absolute inset-0 bg-gray-100 rounded-[2rem] md:rounded-[3rem] transform -rotate-3"></div>
              <img 
                src="https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?q=80&w=1200" 
                alt="Premium carpet installation result" 
                className="relative w-full h-full object-cover rounded-[2rem] md:rounded-[3rem] shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500"
              />
            </FadeIn>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <FadeIn direction="left" delay={100}>
              <div className="flex flex-wrap gap-4 md:gap-6 mb-8 opacity-60 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-300">
                 {/* Simple text placeholders for brands since we don't have SVG logos handy */}
                 <span className="font-bold text-lg md:text-xl text-gray-400">SHAW</span>
                 <span className="font-bold text-lg md:text-xl text-gray-400">MOHAWK</span>
                 <span className="font-bold text-lg md:text-xl text-gray-400">DREAMWEAVER</span>
                 <span className="font-bold text-lg md:text-xl text-gray-400">ENGINEERED</span>
              </div>
            </FadeIn>
            ...
            <div className="space-y-6 md:space-y-8 mb-10 md:mb-12">
              ...
              <FadeIn direction="left" delay={300}>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1">25+ Years of Experience</h3>
              ...
              <FadeIn direction="left" delay={400}>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1">7 Days a Week Availability</h3>
                    <p className="text-sm md:text-base text-gray-600 leading-relaxed">
              ...
              <FadeIn direction="left" delay={500}>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1">100% Customer Satisfaction</h3>
                    <p className="text-sm md:text-base text-gray-600 leading-relaxed">
