            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="tel:+13053236368" className="text-xl font-bold text-primary hover:text-primary-dark">
                    (305) 323-6368
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:fuentescarpets@gmail.com" className="text-xl font-bold text-primary hover:text-primary-dark">
                    fuentescarpets@gmail.com
                  </a>
                </div>
              </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-primary text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-primary-dark transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
