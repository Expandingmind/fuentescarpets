    ...
    <section id="testimonials" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">— Our Features</p>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-shrink-0 text-center lg:text-left lg:w-1/4">
            <div className="inline-block">
              ...
              <p className="text-gray-600 font-medium underline mb-4 cursor-pointer hover:text-gray-900">
                Based on 126+ reviews.
              </p>
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <span className="text-blue-500 font-bold text-3xl font-sans">Google</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-grow w-full relative">
            ...
            <button 
              onClick={prevReview}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-primary hover:scale-110 transition-all border border-gray-100"
            ...
            <button 
              onClick={nextReview}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-primary hover:scale-110 transition-all border border-gray-100"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getVisibleReviews().map((review, index) => (
                <div key={index} className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
