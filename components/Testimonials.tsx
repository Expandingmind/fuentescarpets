                ...
                <FadeIn key={index} delay={index * 150} direction="up" className="h-full">
                  <div className="bg-white border border-gray-100 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] md:text-xs text-gray-400">{review.date}</p>
                        </div>
                      </div>
                    ...
                    <div className="flex gap-1 mb-3">
                      ...
                      <svg className="w-3 h-3 md:w-4 md:h-4 text-blue-500 ml-1" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                      </svg>
                    </div>

                    {/* Review Text */}
                    <p className="text-gray-700 text-xs md:text-sm leading-relaxed flex-grow">
                      {review.text}
                    </p>
                  </div>
                </FadeIn>
