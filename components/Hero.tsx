...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 text-center md:text-left">
        <div className="max-w-3xl">
          <FadeIn delay={0}>
            <div className="inline-block mb-4">
              <span className="bg-primary/20 text-white px-4 py-2 rounded-full text-xs md:text-sm font-semibold tracking-wide backdrop-blur-sm border border-white/20">
          ...
          <FadeIn delay={800}>
            <div className="mt-8">
              <a href="tel:+13053236368" className="text-white text-lg md:text-xl font-semibold hover:text-primary-light transition-colors inline-flex items-center">
